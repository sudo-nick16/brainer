...
const EditWorldModal = ({ }) => {
    ...
    return (
        ...
        >
            <div className='bg-black py-12 px-10 gap-3 flex flex-col w-full relative rounded-3xl border border-accent min-w-[350px] '>
                ...
                <Button onClick={editWorld}>Save</Button>
